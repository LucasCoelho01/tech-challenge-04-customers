...
public class StepDefinition {
    ...
    public void a_customer_payload_with_name_and_email(String username, String cpf, String email) {
        ...
        customerDto = new CustomerDto(username, cpf, email);
    }
    ...
    public void the_response_should_contain_the_customer_s_id_and_details() throws Exception {
        ...
        assertThat(createdCustomer.getUsername()).isEqualTo(customerDto.username());
        assertThat(createdCustomer.getEmail()).isEqualTo(customerDto.email());
        assertThat(createdCustomer.getCpf()).isEqualTo(customerDto.cpf());
    }
